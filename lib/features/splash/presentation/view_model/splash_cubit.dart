...
// import 'package:e_learning/features/bottom_navigatiozn/presentation/view/bottom_navigation_view.dart';
...
class SplashCubit extends Cubit<void> {
  ...
  /// **📌 Handle Navigation Based on Token First**
  Future<void> _handleNavigation(BuildContext context) async {
    final tokenResult = await _tokenSharedPrefs.getToken();
  ...
  /// **📌 Navigate to Onboarding Page (First Time Users)**
  void _goToOnboarding(BuildContext context) {
    if (context.mounted) {
      Navigator.pushReplacement(
        context,
